    ...
    visitor: {
      Program: {
        ...
        exit(path, state) {
          ...
          const dataAst = (0, import_parser.parseExpression)(dataCode, {
            sourceType: "script"
          });
          const insertCode = `(() => {
          ...
          const insertAst = (0, import_parser.parseExpression)(insertCode, {
            sourceType: "script"
          });
...
function locatorLoader(source) {
  ...
  try {
    const result = (0, import_core.transformSync)(source, {
      ...
      plugins: [[transformLocatorJsComponents, { ...options, dataAttribute: "path" }]],
